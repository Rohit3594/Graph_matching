...
if __name__ == "__main__":
    ...
    reg_or_unreg = ''#'_unreg'#''
    methods = ['mALS','media','media_no_excl','media_no_excl_neg_values']#'neuroimage', 'kerGM', 'mALS', 'mSync', 'CAO']#, 'kmeans_70_real_data_dummy','kmeans_90_real_data_dummy','kmeans_110_real_data_dummy']
    #, 'mSync', 'CAO'
