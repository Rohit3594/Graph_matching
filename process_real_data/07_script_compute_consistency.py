...
if __name__ == "__main__":
    ...
    # pickle_out = open(os.path.join(path_to_consistency, "nodeCstPerGraph_mALS.pck"), "wb")
    ...
    # pickle_out = open(os.path.join(path_to_consistency, "nodeCstPerGraph_mSync.pck"),"wb")
    ...
    # pickle_out = open(os.path.join(path_to_consistency, "nodeCstPerGraph_KerGM.pck"),"wb")
