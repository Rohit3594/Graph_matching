...
attn_mat_all = pickle.load(open( "attn_mat_list_layer_3.pickle", "rb" ))
...
for i,g in enumerate(list_graphs):
	...
	s_obj2, c_obj2, node_cb_obj2 = gv.show_graph(g, nodes_coords,node_color_attribute='deg_attn', nodes_size=10, c_map='inferno')
