...
if __name__ == '__main__':
    ...
    nb_runs = 1
    nb_sample_graphs = 20 #  # of graphs to generate before selecting the NN graphs with highest geodesic distance.
    nb_graphs = 10 # nb of graphs to generate
    nb_vertices = 10  #72 based on Kaltenmark, MEDIA, 2020
    min_noise = 800
    max_noise = 1200
    step_noise = 400
    min_outliers = 0
