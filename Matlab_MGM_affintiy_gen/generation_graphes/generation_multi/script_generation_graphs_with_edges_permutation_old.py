...
def generate_reference_graph(nb_vertices, radius):
    ...
    #########################################################
    adja = edges_to_adjacency_matrix(sphere_random_sampling)
...
def generate_graph_family(nb_graphs, nb_vertices, radius, nb_outliers, noise_node=1, noise_edge=1, nb_neighbors_to_consider=10):
    """
    ...
    return ground_truth_perm, list_noisy_graphs, reference_graph
    ...
    for noise in list_noise:
        for outliers in list_outliers:
            ...
            for i_graph in range(nb_runs):
                ...
                ground_truth_perm, list_graphs, reference_graph = generate_graph_family(nb_graphs=nb_graphs, 
...
if __name__ == '__main__':
    ...
    path_to_write='/hpc/meca/users/rohit/stage_nathan/generation_graphes/generation_multi/test_for_pairwise'
