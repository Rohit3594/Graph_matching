...
#$path_to_matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('${path_to_multigraph_algo}'));path='${1}';method='good guess';run('${path_to_multigraph_algo}/Compare_multigraph_algorithms.m');exit;"

# Launch the calculation of the multi-graph algorithms with a mixture of both good guess and KerGM
#$path_to_matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('${path_to_multigraph_algo}'));path='${1}';method='mix';run('${path_to_multigraph_algo}/Compare_multigraph_algorithms.m');exit;"
