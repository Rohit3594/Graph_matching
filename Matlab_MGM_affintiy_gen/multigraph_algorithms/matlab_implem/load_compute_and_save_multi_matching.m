...
function done = load_compute_and_save_multi_matching(path_to_run, pairwise_method, mix_rate, path_to_save, nb_graphs_to_use)
%clear all
clear affinity
global affinity target

% get the necessary info
nb_graphs_total = length(dir(strcat(path_to_run, "/graphs/*.gpickle")));
