...
if __name__ == "__main__":
    ...
    path_to_read = '/hpc/meca/users/rohit/stage_nathan/data/real_data_result/modified_graphs/0/'
    ...
    #matching_CAO = sio.loadmat(os.path.join(path_to_read,"X_cao_cst_o.mat"))["X"]
    matching_Hippi = np.load(os.path.join(path_to_read,"Hippi_res_real_mat.npy"))
    ...
    #nodeCstPerGraph_CAO = compute_node_consistency(matching_CAO, nb_graphs, nb_nodes)
    ...
    #pickle_out.close()
    #pickle_out = open(os.path.join(path_to_read,"nodeCstPerGraph_CAO.pck"),"wb")
    ...
    #print(np.mean(nodeCstPerGraph_CAO))
