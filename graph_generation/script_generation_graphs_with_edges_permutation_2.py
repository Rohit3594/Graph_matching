...
def generate_n_graph_family_and_save(path_to_write, nb_runs, nb_ref_graph, nb_sample_graphs,nb_graphs, nb_vertices,
                                     radius, list_noise, list_outliers, nb_neighbors_to_consider=10, save_reference=0,load_ref=None):
    ...
    if load_ref is not None:
        reference_graph_max = nx.read_gpickle(load_ref)
        trial_path = path_to_write
    else:
...
if __name__ == '__main__':
    path_to_write = '/home/rohit/PhD_Work/GM_my_version/final_new_simu/other_9_trials/1/'
    ...
    load_ref = path_to_write+'/reference_1.gpickle'
