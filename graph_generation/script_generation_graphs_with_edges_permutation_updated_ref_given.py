...
def generate_n_graph_family_and_save(path_to_write, nb_runs, nb_ref_graph, nb_sample_graphs,nb_graphs, nb_vertices,
    radius, list_noise, max_outliers, nb_neighbors_to_consider=10,ref_path=None, save_reference=0):
    ...
    # generate n families of graphs given the reference graph
    for i_graph in range(nb_runs):

        reference_graph_max = nx.read_gpickle(path_to_ref)

        trial_path = os.path.join(path_to_write, str(i_graph))
...
if __name__ == '__main__':
    ...
    path_to_write = '/home/rohit/PhD_Work/GM_my_version/Graph_matching/data/simu_graph/Simu_high_noise_given_ref_k_1000/'

    path_to_ref =  '/home/rohit/PhD_Work/GM_my_version/Graph_matching/data/simu_graph/Simu_high_noise_given_ref_k_1000/ref_1000.gpickle'



    nb_runs = 1
    nb_sample_graphs = 5 #  # of graphs to generate before selecting the NN graphs with highest geodesic distance.(NOT APPLICABLE HERE)
    nb_graphs = 500 #137(# of subj in OASIS) # nb of graphs to generate
